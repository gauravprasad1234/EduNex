...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full pt-0 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
      ...
      <h1 className='md:text-home-heading-large text-home-heading-small font-bold text-gray-800 max-w-3xl mx-auto relative'>
        ...
        <span className="relative inline-block text-blue-600">
          ...
          <img
            ...
            left-1/2 -translate-x-1/2 w-28 md:w-36"
          />
        </span>
      </h1>
