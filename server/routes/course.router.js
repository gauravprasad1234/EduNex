...
import { createCourse, enrollInCourse, getAllCourses, getEnrollments, getOneCourse, readEducatorCourses } from '../controllers/course.controller.js'
...
router.get("/my-enrollments",isLoggedin,getEnrollments)
